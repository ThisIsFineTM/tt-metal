...
extern template class std::vector<tt::tt_metal::SubDeviceId>;
extern template class std::vector<std::shared_ptr<tt::tt_metal::Event>>;
extern template class std::optional<ttnn::MeshCoordinateRange>;
