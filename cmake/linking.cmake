...
if(TT_ENABLE_LTO)
    ...
    if(lto_supported)
        ...
        add_link_options(
            ...
            $<$<AND:$<CONFIG:Release,RelWithDebInfo>,$<$<CXX_COMPILER_ID:Clang>>:-Wl,--thinlto-cache-policy=cache_size_bytes=2g:cache_size=10%:cache_size_files=10000>
        ...
        add_compile_options(
            ...
            $<$<AND:$<CONFIG:Release,RelWithDebInfo>,$<$<CXX_COMPILER_ID:GNU>>:-flto-incremental-cache-size=5000>
